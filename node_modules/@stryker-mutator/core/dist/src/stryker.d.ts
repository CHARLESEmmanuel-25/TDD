...
import { PrepareExecutorContext } from './process/index.js';
...
export declare class Stryker {
     ...
     * @internal
     */
    static run(mutationRunInjector: Injector<MutationRunContext>, cliOptions: PartialStrykerOptions): Promise<MutantResult[]>;
}
export {};
